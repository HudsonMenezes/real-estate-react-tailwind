    ...
    <section>
      <div className="container mx-auto min-h-[800px] mb-14">
        <div className="flex flex-col lg:flex-row lg:items-center lg: justify-between">
          <div>
            <h2 className="text-2xç font-semibold">{house.name}</h2>
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          <div className="max-w-[768px]">
            <div className="mb-8">
              <img src={house.imageLg} alt="Imagem Grande" />
            </div>
          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
            ...
            <form className="flex flex-col gap-y-4">
              ...
              <textarea
                ...
                defaultValue="Olá, eu estou interessado(a) neste imóvel"
              ></textarea>
              <div className="flex gap-x-2">
                <button className="bg-violet-700 hover:bg-violet-800 text-white rounded p-4 text-sm w-full transition">
                  Enviar mensagem
                </button>
                <button className="border border-violet-700 text-violet-700 hover:border-vilet-500 hover:text-violet-500 rounded p-4 text-sm w-full transition">
                  Ligar
                </button>
              </div>
            </form>
